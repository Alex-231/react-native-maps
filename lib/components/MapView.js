...
class MapView extends React.Component {
   ...
   * @return Object Object bounding box ({ northEast: <LatLng>, southWest: <LatLng> })
   */
  boundingBoxForCoordinates(coordinates) {
    if (Platform.OS === 'android') {
      return await NativeModules.AirMapModule.boundingBoxForCoordinates(coordinates);
    } else if (Platform.OS === 'ios') {
      return await this._runCommand('boundingBoxForCoordinates', [coordinates]);
    }
    return Promise.reject('boundingBoxForCoordinates not supported on this platform');
  }
